...
export default function AboutMe() {
  ...
  return (
    <main className="bg-white dark:bg-black">
      {/* Hero Section */}
      <section className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white dark:from-black dark:via-gray-950 dark:to-black flex items-center justify-center py-20 sm:py-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-block px-4 py-2 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-full mb-6">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">About Me</span>
              </div>
            ...
            <div className="flex justify-center">
              <div className="relative w-[320px] h-[480px] sm:w-[400px] sm:h-[600px] rounded-2xl overflow-hidden border-2 border-gray-200 dark:border-gray-800">
                <img
      ...
      <section className="py-12 bg-white dark:bg-black">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="border-t border-gray-200 dark:border-gray-800 pt-10">
            <h3 className="text-2xl font-bold text-black dark:text-white mb-6">Soft Skills</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {softSkills.map((skill, index) => (
                <div
                  key={index}
                  className="p-6 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <h4 className="text-lg font-semibold text-black dark:text-white">{skill}</h4>
                  </div>
                </div>
              ))}
            </div>
